            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="level_name" id="level_name" class="form-control" value="{{ $level->level_name }}" required>
        ...
        $(document).ready(function () {
            $('#form-edit').validate({
                rules: {
                    ...
                    level_name: { required: true, minlength: 3, maxlength: 50, pattern: /^[a-zA-Z]+$/ }
                }, 
