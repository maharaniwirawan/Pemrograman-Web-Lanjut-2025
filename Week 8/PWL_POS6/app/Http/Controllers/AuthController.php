...
class AuthController extends Controller
{
    ...
    public function register() {
        try {
            $levels = LevelModel::where('level_name', '!=', 'Administrator')->get();
    ...
    public function postRegister(Request $request) {
        $validator = Validator::make($request->all(), [
            ...
            'level_id' => 'required|exists:m_level,level_id|not_in:' .  LevelModel::where('level_name', 'Administrator')->value('level_id')
        ], [
